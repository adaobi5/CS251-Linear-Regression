...
class LinearRegression(analysis.Analysis):
    ...
    def mean_sse(self):
        ...
        #compute residuals for predicted y values
    ...
    def pair_plot(self, data_vars, fig_sz=(12, 12), hists_on_diag=True):
        ...
        # a list of indices of headers 
        indList = []										
        varLength = len(data_vars)

        # repeat variable number of times
        for i in range(varLength):
            # each variable in the list of strings							
            for var in data_vars:
                # use the dictionary							 	
                indList.append(self.data.header2col[var])
        # repeat variable number of times times		
        for i in range(varLength):								
            ...
            for j in range(varLength):
                ...
                if hists_on_diag is True and (i!=j):
                    # no regression line on histogram diagonal			
